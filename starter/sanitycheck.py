...
def run_sanity_check(test_dir):
    ...
    if not test_functions_for_get:
        ...
        if not TEST_FOR_GET_METHOD_RESPONSE_CODE:
            ...
            WARNING_COUNT += 1
            print(
                FAIL_COLOR+"Your test case for GET() \
                    does not seem to be testing the response code.\n")
    ...
    print(WARN_COLOR+"You should still check your \
...
if __name__ == "__main__":
    ...
    parser.add_argument('test_dir', metavar='test_dir', nargs='?',
                        default='tests', help='Name of the \
                            directory that has test files.')
